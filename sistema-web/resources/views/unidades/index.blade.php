                                ...
                                @forelse($unidades ?? [] as $unidad)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" 
                                                    class="btn"
                                                    style="background-color: #5A2828; color: white; border-radius: 5px; padding: 8px 20px; border: none; margin-right: 8px;"
                                            ...
                                            <form action="{{ route('unidades.destroy', $unidad->id) }}" method="POST" style="display: inline-block;">
                                                ...
                                                <button type="submit" 
                                                        class="btn"
                                                        style="background-color: #5A2828; color: white; border-radius: 5px; padding: 8px 20px; border: none;"
